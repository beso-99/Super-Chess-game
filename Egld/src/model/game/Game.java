...
public class Game {
	...
	public void assemblePieces() {
		...
		Speedster sp1 = new Speedster(player1, this, "Speedster 1");
		board[p1InitRow + 1][ind1.remove(0)].setPiece(sp1);

		Speedster sp2 = new Speedster(player2, this, "Speedster 2");
		...
		for (int j = 0; j < boardWidth; j++) {
			board[p1InitRow][j].setPiece(new SideKickP1(this, "SideKick 1"));
			board[p2InitRow + 1][j].setPiece(new SideKickP2(this, "SideKick 2"));
		}
		for (int i = 0; i < board.length; i++)
