...
public class Tech extends ActivatablePowerHero {
	...
	public void moveRight() throws UnallowedMovementException {
		throw new UnallowedMovementException("Tech can't move in this direction",this, Direction.RIGHT);
	}

	@Override
	public void moveLeft() throws UnallowedMovementException {
		throw new UnallowedMovementException("Tech can't move in this direction",this, Direction.LEFT);
	}
